"""Reuse the existing VN baseline epoch-zero artifact without changing its contract.
...
BASELINE = "SepReformer_Base_VnSpeechMix_16K"
CANDIDATE = "SepReformer_LTRR_VnSpeechMix_16K"
...
def baseline_artifact_config(config):
    ...
    if (settings["baseline_model"] != BASELINE
        ...
        raise ValueError("LTRR requires the declared VN baseline and ltrr. parameter prefix.")
